...
import type { CoSignTransport } from '@gibs/msgboard-games'
import type { VerifyContext } from '@gibs/msgboard-games'
import type { DiceParams } from '@gibs/msgboard-games'
import { TEST_DOMAIN } from '@gibs/msgboard-games'
