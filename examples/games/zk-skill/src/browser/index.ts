// Browser entrypoint for @gibs/zk-skill — the proving-key loader + in-worker PLONK prover.
//
// Exposed as a SEPARATE package subpath (`@gibs/zk-skill/browser`) rather than from the package root
