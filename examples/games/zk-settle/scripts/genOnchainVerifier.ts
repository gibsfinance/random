 ...
 *
 * Run:  pnpm --filter @gibs/zk-settle gen:onchain-verifier
...
async function main() {
  ...
  try {
    ...
    const verifierDir = resolve(repoRoot, 'packages/contracts/contracts/zk/generated')
    ...
    const fixtureDir = resolve(repoRoot, 'packages/contracts/test/foundry/fixtures')
