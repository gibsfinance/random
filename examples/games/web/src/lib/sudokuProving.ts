// Browser-side driver for the Sudoku solve proof. Wires @gibs/zk-skill's in-worker PLONK prover to
...
import { buildSudokuWitnessInput } from '@gibs/zk-skill/sudoku'
