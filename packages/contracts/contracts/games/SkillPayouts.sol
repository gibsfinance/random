...
///   examples/games/msgboard-games/src/games/sudoku.ts  (SUDOKU_MULT_X100 flat)
...
library SkillPayouts {
    ...
    // --- ZK-Sudoku (gameId 31) — mirror SUDOKU_MULT_X100 ---
    uint8 internal constant SUDOKU_GAME_ID = 31;
    uint256 internal constant SUDOKU_MULT_X100 = 190; // flat 1.90x on a proven solve
    ...
    /// Sudoku payout multiplier (×100): the flat solve multiplier, or 0 if unsolved.
    function sudokuMultX100(bool solved) internal pure returns (uint256) {
        return solved ? SUDOKU_MULT_X100 : 0;
    }
