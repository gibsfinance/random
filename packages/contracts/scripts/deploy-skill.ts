...
async function main(): Promise<void> {
  ...
  if (!mnemonic) throw new Error('set MNEMONIC in the environment (packages/contracts/.env)')
  ...
  console.log('  - Wire the new addresses into examples/games/web/src/config.ts + the indexer.')
